const translations = {
  es: {
    ...
    pilotName: 'Nombre del piloto', pilotPlaceholder: 'Ej: Lu', startSimulation: 'Iniciar simulación', loginCopy: 'No requiere login. El ranking guarda nombre, score, oleadas y bajas.',
  ...
  en: {
    ...
    pilotName: 'Pilot name', pilotPlaceholder: 'Ex: Lu', startSimulation: 'Start simulation', loginCopy: 'No login required. The leaderboard stores name, score, waves, and kills.',
